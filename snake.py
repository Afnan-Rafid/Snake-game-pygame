...
class Snake:
    def __init__(self):
        ...
        self.eat_sound = pg.mixer.Sound("Sounds/eat.mp3")
        self.wall_hit_sound = pg.mixer.Sound("Sounds/wall.mp3")

    def draw(self):
        for segment in self.body:
            segment_rect = (OFFSET + segment.x*cell_size, OFFSET +segment.y*cell_size,cell_size,cell_size)
            pg.draw.rect(screen, DARK_GREEN, segment_rect,0,8)
...
SNAKE_UPDATE= pg.USEREVENT #custom events
